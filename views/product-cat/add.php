				...
				<?php if ($productCatForm->pid == 0):?>
					...
					<div class="form-group">
						...
						<div class="col-sm-6" id="iconDiv">
							<?php if (!empty($productCatForm->icon_bgcolor) && !empty($productForm->icon)):?>
								<img src='<?=$productForm->icon?>' style='border-radius: 40px;width:80px;background:#<?=$productCatForm->icon_bgcolor?>;' id='icon_image_ele'/>
							<?php endif;?>
						</div>
						<div class="col-sm-3">
						</div>
